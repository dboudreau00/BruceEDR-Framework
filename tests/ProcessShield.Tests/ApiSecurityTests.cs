...
using Xunit;
using static ProcessShield.Tests.ApiSecurityFixture;

namespace ProcessShield.Tests;

// ---------------------------------------------------------------------------
// Tests for ProcessShield.Api.EndpointAnalyzer.
//
...
public class ApiSecurityBodyTests
{
    ...
    {
        // Contract with ProcessShield.Intel.SecretScanner: whatever its rules match, the
