...
public sealed class TrayIcon : IDisposable
{
    ...
    public TrayIcon(Window window)
    {
        ...
        menu.Items.Add("Open ProcessShield", null, (_, _) => Restore());
        menu.Items.Add(new System.Windows.Forms.ToolStripSeparator());
        menu.Items.Add("Exit", null, (_, _) => _window.Close());

        _icon = new System.Windows.Forms.NotifyIcon
        {
            Text = "ProcessShield — monitoring",
        ...
        try
        {
            var uri = new Uri("pack://application:,,,/ProcessShield.Gui;component/Assets/shield.ico");
    ...
    public void HideToTray()
    {
        try
        {
            ...
            if (!_hiddenBalloonShown)
            {
                ...
                Notify("Still monitoring", "ProcessShield keeps watching from the tray. Double-click the shield to reopen.");
            }
        }
